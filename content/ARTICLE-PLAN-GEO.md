...
|---|------|------------|-------|------:|
| G0-1 | `mongol-poker-bairshil` | Монгол покер — байршлаар | «покер монгол хаана», индекс городов/регионов/диаспоры | 1400 |
...
|---|------|------|--------------|--------------|
| G1-1 | `darkhan-poker-2026` | Darkhan | покер дархан | №2 город, промышленный, близко к UB |
| G1-2 | `erdenet-poker-2026` | Erdenet | покер эрдэнэт | №3, Orkhon, сменные графики |
| G1-3 | `choibalsan-poker-mongol` | Choibalsan | покер чойбалсан / дорнод | восток, RU-влияние, граница |
...
|---|------|--------|-----------------|-------|
| G2-1 | `baruun-mongol-poker` | Баруун | Khovd, Uvs, Bayan-Ölgii, Govi-Altai, Zavkhan | запад, расстояния, мобильный интернет |
| G2-2 | `dorvon-mongol-poker` | Дорнод | Dornod, Sukhbaatar, Khentii | восток, РФ-соседство, русский FAQ block |
...
|---|------|--------|--------------|-------|
| G3-1 | `mongol-poker-south-korea` | 🇰🇷 South Korea | mongol poker korea / монгол покер солонгос | крупнейшая диаспора, KST vs ULAT |
